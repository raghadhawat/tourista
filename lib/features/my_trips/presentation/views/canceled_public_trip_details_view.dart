...
import 'package:tourista/features/my_trips/presentation/views/widgets/canceled_public_body.dart';
import 'package:tourista/features/ready_trips/presentation/manager/ready_trip_details_cubit/ready_trip_details_cubit.dart';

class CanceledPublicTripDetailsView extends StatelessWidget {
  const CanceledPublicTripDetailsView({super.key});
