...
import 'package:tourista/features/private_trip/flights/presentation/views/widgets/ticket_time_start_and_end_round.dart';

class TicketTimeAndAirlineRound extends StatelessWidget {
  const TicketTimeAndAirlineRound({
    super.key,
    required this.width,
